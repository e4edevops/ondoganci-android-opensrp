 ...
 */
public class PentaCohortDropoutReportActivity extends BaseReportActivity implements NavDrawerActivity, NavigationMenuContract {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (titleTv != null && reportGrouping != null) {
            ...
            if (humanReadableTitle != null) {
                titleTv.setText(getString(R.string.penta_cohort_dropout_report));
            }
        }
    ...
    private void createDrawer() {
        WeakReference<PentaCohortDropoutReportActivity> weakReference = new WeakReference<>(this);
