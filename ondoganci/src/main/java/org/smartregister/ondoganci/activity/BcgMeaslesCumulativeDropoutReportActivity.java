 ...
 */
public class BcgMeaslesCumulativeDropoutReportActivity extends BaseReportActivity implements NavDrawerActivity, NavigationMenuContract {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (titleTv != null && reportGrouping != null) {
            ...
            if (humanReadableTitle != null) {
                titleTv.setText(getString(R.string.bcg_measles_cumulative_dropout_report));
            }
        }
    ...
    private void createDrawer() {
        WeakReference<BcgMeaslesCumulativeDropoutReportActivity> weakReference = new WeakReference<>(this);
