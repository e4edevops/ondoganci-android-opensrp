...
import org.smartregister.ondoganci.interactor.NavigationInteractor;
import org.smartregister.ondoganci.model.NavigationModel;
...
public class NavigationPresenter implements NavigationContract.Presenter {
    ...
    public void sync(Activity activity) {
        ...
        HeadIntentServiceJob.scheduleJobImmediately(HeadIntentServiceJob.TAG);
